...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Roasted Red Pepper And Tomato Bread Soup");
            findEmission("Roasted Red Pepper And Tomato Bread Soup");
            findNutrition("Roasted Red Pepper And Tomato Bread Soup");
            findIngredients("Roasted Red Pepper And Tomato Bread Soup");
            findInstructions("Roasted Red Pepper And Tomato Bread Soup");
...
<div class="breadcrumb container">
    ...
    <span>Roasted Red Pepper And Tomato Bread Soup</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="roasted_red" src="images/recipe/Roasted Red Pepper And Tomato Bread Soup.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Roasted Red Pepper And Tomato Bread Soup</h3>
