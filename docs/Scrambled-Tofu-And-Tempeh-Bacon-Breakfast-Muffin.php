...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Scrambled Tofu And Tempeh Bacon Breakfast Muffin");
            findEmission("Scrambled Tofu And Tempeh Bacon Breakfast Muffin");
            findNutrition("Scrambled Tofu And Tempeh Bacon Breakfast Muffin");
            findIngredients("Scrambled Tofu And Tempeh Bacon Breakfast Muffin");
            findInstructions("Scrambled Tofu And Tempeh Bacon Breakfast Muffin");
...
<div class="breadcrumb container">
    ...
    <span>Scrambled Tofu And Tempeh Bacon Breakfast Muffin</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="scrambled_tofu" src="images/recipe/Scrambled Tofu And Tempeh Bacon Breakfast Muffin.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Scrambled Tofu And Tempeh Bacon Breakfast Muffin</h3>
