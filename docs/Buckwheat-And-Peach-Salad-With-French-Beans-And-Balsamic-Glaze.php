...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Buckwheat And Peach Salad With French Beans And Balsamic Glaze");
            findEmission("Buckwheat And Peach Salad With French Beans And Balsamic Glaze");
            findNutrition("Buckwheat And Peach Salad With French Beans And Balsamic Glaze");
            findIngredients("Buckwheat And Peach Salad With French Beans And Balsamic Glaze");
            findInstructions("Buckwheat And Peach Salad With French Beans And Balsamic Glaze");
...
<div class="breadcrumb container">
    ...
    <span>Buckwheat And Peach Salad With French Beans And Balsamic Glaze</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="buckwheat" src="images/recipe/Buckwheat And Peach Salad With French Beans And Balsamic Glaze.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Buckwheat And Peach Salad With French Beans And Balsamic Glaze</h3>
