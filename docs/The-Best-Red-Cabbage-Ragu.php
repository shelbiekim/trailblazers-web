...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("The Best Red Cabbage Ragu");
            findEmission("The Best Red Cabbage Ragu");
            findNutrition("The Best Red Cabbage Ragu");
            findIngredients("The Best Red Cabbage Ragu");
            findInstructions("The Best Red Cabbage Ragu");
...
<div class="breadcrumb container">
    ...
    <span>The Best Red Cabbage Ragu</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="the_best_red" src="images/recipe/The Best Red Cabbage Ragu.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">The Best Red Cabbage Ragu</h3>
