...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("20 Minute Vegan Banana Cake");
            findEmission("20 Minute Vegan Banana Cake");
            findNutrition("20 Minute Vegan Banana Cake");
            findIngredients("20 Minute Vegan Banana Cake");
            findInstructions("20 Minute Vegan Banana Cake");
...
<div class="breadcrumb container">
    ...
    <span>20 Minute Vegan Banana Cake</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="20_minute" src="images/recipe/20 Minute Vegan Banana Cake.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">20 Minute Vegan Banana Cake</h3>
