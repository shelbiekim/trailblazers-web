...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Spelt And Courgette Summer Soup");
            findEmission("Spelt And Courgette Summer Soup");
            findNutrition("Spelt And Courgette Summer Soup");
            findIngredients("Spelt And Courgette Summer Soup");
            findInstructions("Spelt And Courgette Summer Soup");
...
<div class="breadcrumb container">
    ...
    <span>Spelt And Courgette Summer Soup</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="spelt" src="images/recipe/Spelt And Courgette Summer Soup.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Spelt And Courgette Summer Soup</h3>
