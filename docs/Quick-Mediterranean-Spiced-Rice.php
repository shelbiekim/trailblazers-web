...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Quick Mediterranean Spiced Rice");
            findEmission("Quick Mediterranean Spiced Rice");
            findNutrition("Quick Mediterranean Spiced Rice");
            findIngredients("Quick Mediterranean Spiced Rice");
            findInstructions("Quick Mediterranean Spiced Rice");
...
<div class="breadcrumb container">
    ...
    <span>Quick Mediterranean Spiced Rice</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="quick_mediterranean" src="images/recipe/Quick Mediterranean Spiced Rice.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Quick Mediterranean Spiced Rice</h3>
