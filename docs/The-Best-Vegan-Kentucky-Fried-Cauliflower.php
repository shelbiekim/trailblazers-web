...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("The Best Vegan Kentucky Fried Cauliflower");
            findEmission("The Best Vegan Kentucky Fried Cauliflower");
            findNutrition("The Best Vegan Kentucky Fried Cauliflower");
            findIngredients("The Best Vegan Kentucky Fried Cauliflower");
            findInstructions("The Best Vegan Kentucky Fried Cauliflower");
...
<div class="breadcrumb container">
    ...
    <span>The Best Vegan Kentucky Fried Cauliflower</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="the_best_vegan" src="images/recipe/The Best Vegan Kentucky Fried Cauliflower.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">The Best Vegan Kentucky Fried Cauliflower</h3>
