...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios");
            findEmission("Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios");
            findNutrition("Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios");
            findIngredients("Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios");
            findInstructions("Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios");
...
<div class="breadcrumb container">
    ...
    <span>Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="vegan_rice" src="images/recipe/Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Vegan Rice Pudding With Caramelized Blood Oranges And Pistachios</h3>
