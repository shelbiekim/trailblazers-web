...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs");
            findEmission("Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs");
            findNutrition("Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs");
            findIngredients("Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs");
            findInstructions("Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs");
...
<div class="breadcrumb container">
    ...
    <span>Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="heritage" src="images/recipe/Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Heritage Tomato And Couscous Salad With Toasted Thyme Breadcrumbs</h3>
