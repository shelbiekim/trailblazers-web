...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Mustardy Potato Salad With Rocket And Radish");
            findEmission("Mustardy Potato Salad With Rocket And Radish");
            findNutrition("Mustardy Potato Salad With Rocket And Radish");
            findIngredients("Mustardy Potato Salad With Rocket And Radish");
            findInstructions("Mustardy Potato Salad With Rocket And Radish");
...
<div class="breadcrumb container">
    ...
    <span>Mustardy Potato Salad With Rocket And Radish</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="mustardy_potato" src="images/recipe/Mustardy Potato Salad With Rocket And Radish.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Mustardy Potato Salad With Rocket And Radish</h3>
