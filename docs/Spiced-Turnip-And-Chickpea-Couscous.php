...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Spiced Turnip And Chickpea Couscous");
            findEmission("Spiced Turnip And Chickpea Couscous");
            findNutrition("Spiced Turnip And Chickpea Couscous");
            findIngredients("Spiced Turnip And Chickpea Couscous");
            findInstructions("Spiced Turnip And Chickpea Couscous");
...
<div class="breadcrumb container">
    ...
    <span>Spiced Turnip And Chickpea Couscous</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="spiced" src="images/recipe/Spiced Turnip And Chickpea Couscous.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Spiced Turnip And Chickpea Couscous</h3>
