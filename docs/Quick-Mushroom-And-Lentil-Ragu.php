...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Quick Mushroom And Lentil Ragu");
            findEmission("Quick Mushroom And Lentil Ragu");
            findNutrition("Quick Mushroom And Lentil Ragu");
            findIngredients("Quick Mushroom And Lentil Ragu");
            findInstructions("Quick Mushroom And Lentil Ragu");
...
<div class="breadcrumb container">
    ...
    <span>Quick Mushroom And Lentil Ragu</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="quick_mushroom" src="images/recipe/Quick Mushroom And Lentil Ragu.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Quick Mushroom And Lentil Ragu</h3>
