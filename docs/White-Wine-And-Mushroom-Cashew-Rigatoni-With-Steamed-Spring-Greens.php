...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens");
            findEmission("White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens");
            findNutrition("White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens");
            findIngredients("White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens");
            findInstructions("White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens");
...
<div class="breadcrumb container">
    ...
    <span>White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="white_wine" src="images/recipe/White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">White Wine And Mushroom Cashew Rigatoni With Steamed Spring Greens</h3>
