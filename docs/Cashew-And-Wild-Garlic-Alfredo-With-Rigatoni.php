...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Cashew And Wild Garlic Alfredo With Rigatoni");
            findEmission("Cashew And Wild Garlic Alfredo With Rigatoni");
            findNutrition("Cashew And Wild Garlic Alfredo With Rigatoni");
            findIngredients("Cashew And Wild Garlic Alfredo With Rigatoni");
            findInstructions("Cashew And Wild Garlic Alfredo With Rigatoni");
...
<div class="breadcrumb container">
    ...
    <span>Cashew And Wild Garlic Alfredo With Rigatoni</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="cashew" src="images/recipe/Cashew And Wild Garlic Alfredo With Rigatoni.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Cashew And Wild Garlic Alfredo With Rigatoni</h3>
