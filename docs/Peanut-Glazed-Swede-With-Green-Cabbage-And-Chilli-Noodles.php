...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Peanut Glazed Swede With Green Cabbage And Chilli Noodles");
            findEmission("Peanut Glazed Swede With Green Cabbage And Chilli Noodles");
            findNutrition("Peanut Glazed Swede With Green Cabbage And Chilli Noodles");
            findIngredients("Peanut Glazed Swede With Green Cabbage And Chilli Noodles");
            findInstructions("Peanut Glazed Swede With Green Cabbage And Chilli Noodles");
...
<div class="breadcrumb container">
    ...
    <span>Peanut Glazed Swede With Green Cabbage And Chilli Noodles</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="peanut" src="images/recipe/Peanut Glazed Swede With Green Cabbage And Chilli Noodles.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Peanut Glazed Swede With Green Cabbage And Chilli Noodles</h3>
            <img class="tree_icons" src="images/half_tree_icon.png" height="30"/>&nbsp;&nbsp;<span class='glyphicon glyphicon-info-sign my-tooltip' title="required to offset footprint per one serve"></span>
            <hr class="minor" />
