...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Stovetop Popcorn With A Baked Orange Glaze");
            findEmission("Stovetop Popcorn With A Baked Orange Glaze");
            findNutrition("Stovetop Popcorn With A Baked Orange Glaze");
            findIngredients("Stovetop Popcorn With A Baked Orange Glaze");
            findInstructions("Stovetop Popcorn With A Baked Orange Glaze");
...
<div class="breadcrumb container">
    ...
    <span>Stovetop Popcorn With A Baked Orange Glaze</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="stovetop" src="images/recipe/Stovetop Popcorn With A Baked Orange Glaze.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Stovetop Popcorn With A Baked Orange Glaze</h3>
