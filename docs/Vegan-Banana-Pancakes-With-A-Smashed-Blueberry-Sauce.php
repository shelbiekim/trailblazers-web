...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Vegan Banana Pancakes With A Smashed Blueberry Sauce");
            findEmission("Vegan Banana Pancakes With A Smashed Blueberry Sauce");
            findNutrition("Vegan Banana Pancakes With A Smashed Blueberry Sauce");
            findIngredients("Vegan Banana Pancakes With A Smashed Blueberry Sauce");
            findInstructions("Vegan Banana Pancakes With A Smashed Blueberry Sauce");
...
<div class="breadcrumb container">
    ...
    <span>Vegan Banana Pancakes With A Smashed Blueberry Sauce</span>
</div>
<!-- Banner -->
<div class="container">
