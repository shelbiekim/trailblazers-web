...
//use localStorage - openDiv(), save(), load() - for sidebar profile
            ...
            findRecipe("Onion Bhajis (Plain Flour Recipe)");
            findEmission("Onion Bhajis (Plain Flour Recipe)");
            findNutrition("Onion Bhajis (Plain Flour Recipe)");
            findIngredients("Onion Bhajis (Plain Flour Recipe)");
            findInstructions("Onion Bhajis (Plain Flour Recipe)");
...
<div class="breadcrumb container">
    ...
    <span>Onion Bhajis (Plain Flour Recipe)</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="onion_bhajis" src="images/recipe/Onion Bhajis (Plain Flour Recipe).jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Onion Bhajis (Plain Flour Recipe)</h3>
