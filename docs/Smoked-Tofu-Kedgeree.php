...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Smoked Tofu Kedgeree");
            findEmission("Smoked Tofu Kedgeree");
            findNutrition("Smoked Tofu Kedgeree");
            findIngredients("Smoked Tofu Kedgeree");
            findInstructions("Smoked Tofu Kedgeree");
...
<div class="breadcrumb container">
    ...
    <span>Smoked Tofu Kedgeree</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="smoked_tofu" src="images/recipe/Smoked Tofu Kedgeree.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Smoked Tofu Kedgeree</h3>
