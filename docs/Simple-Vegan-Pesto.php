...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Simple Vegan Pesto");
            findEmission("Simple Vegan Pesto");
            findNutrition("Simple Vegan Pesto");
            findIngredients("Simple Vegan Pesto");
            findInstructions("Simple Vegan Pesto");
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="simple_vegan" src="images/recipe/Simple Vegan Pesto.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Simple Vegan Pesto</h3>
