...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Chillied Rice With Zaatar Roast Chickpeas And Flat Beans");
            findEmission("Chillied Rice With Zaatar Roast Chickpeas And Flat Beans");
            findNutrition("Chillied Rice With Zaatar Roast Chickpeas And Flat Beans");
            findIngredients("Chillied Rice With Zaatar Roast Chickpeas And Flat Beans");
            findInstructions("Chillied Rice With Zaatar Roast Chickpeas And Flat Beans");
...
<div class="breadcrumb container">
    ...
    <span>Chillied Rice With Zaatar Roast Chickpeas And Flat Beans</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="chillied" src="images/recipe/Chillied Rice With Zaatar Roast Chickpeas And Flat Beans.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Chillied Rice With Zaatar Roast Chickpeas And Flat Beans</h3>
            <img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/half_tree_icon.png" height="30"/>&nbsp;&nbsp;<span class='glyphicon glyphicon-info-sign my-tooltip' title="required to offset footprint per one serve"></span>
            <hr class="minor" />
