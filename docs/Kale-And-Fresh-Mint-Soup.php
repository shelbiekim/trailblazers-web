...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Kale And Fresh Mint Soup");
            findEmission("Kale And Fresh Mint Soup");
            findNutrition("Kale And Fresh Mint Soup");
            findIngredients("Kale And Fresh Mint Soup");
            findInstructions("Kale And Fresh Mint Soup");
...
<div class="breadcrumb container">
    ...
    <span>Kale And Fresh Mint Soup</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="kale" src="images/recipe/Kale And Fresh Mint Soup.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Kale And Fresh Mint Soup</h3>
