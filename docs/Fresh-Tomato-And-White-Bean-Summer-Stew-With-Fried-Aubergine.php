...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Fresh Tomato And White Bean Summer Stew With Fried Aubergine");
            findEmission("Fresh Tomato And White Bean Summer Stew With Fried Aubergine");
            findNutrition("Fresh Tomato And White Bean Summer Stew With Fried Aubergine");
            findIngredients("Fresh Tomato And White Bean Summer Stew With Fried Aubergine");
            findInstructions("Fresh Tomato And White Bean Summer Stew With Fried Aubergine");
...
<div class="breadcrumb container">
    ...
    <span>Fresh Tomato And White Bean Summer Stew With Fried Aubergine</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="fresh_tomato" src="images/recipe/Fresh Tomato And White Bean Summer Stew With Fried Aubergine.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Fresh Tomato And White Bean Summer Stew With Fried Aubergine</h3>
