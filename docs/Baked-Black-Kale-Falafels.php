...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Baked Black Kale Falafels");
            findEmission("Baked Black Kale Falafels");
            findNutrition("Baked Black Kale Falafels");
            findIngredients("Baked Black Kale Falafels");
            findInstructions("Baked Black Kale Falafels");
...
<div class="breadcrumb container">
    ...
    <span>Baked Black Kale Falafels</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="baked_black_kale" src="images/recipe/Baked Black Kale Falafels.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Baked Black Kale Falafels</h3>
