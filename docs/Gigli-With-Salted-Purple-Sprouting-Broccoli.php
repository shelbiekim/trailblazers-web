...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Gigli With Salted Purple Sprouting Broccoli");
            findEmission("Gigli With Salted Purple Sprouting Broccoli");
            findNutrition("Gigli With Salted Purple Sprouting Broccoli");
            findIngredients("Gigli With Salted Purple Sprouting Broccoli");
            findInstructions("Gigli With Salted Purple Sprouting Broccoli");
...
<div class="breadcrumb container">
    ...
    <span>Gigli With Salted Purple Sprouting Broccoli</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="gigli" src="images/recipe/Gigli With Salted Purple Sprouting Broccoli.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Gigli With Salted Purple Sprouting Broccoli</h3>
