...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Creamed Aubergine Wheat With Fried Sugar Snap Peas");
            findEmission("Creamed Aubergine Wheat With Fried Sugar Snap Peas");
            findNutrition("Creamed Aubergine Wheat With Fried Sugar Snap Peas");
            findIngredients("Creamed Aubergine Wheat With Fried Sugar Snap Peas");
            findInstructions("Creamed Aubergine Wheat With Fried Sugar Snap Peas");
...
<div class="breadcrumb container">
    ...
    <span>Creamed Aubergine Wheat With Fried Sugar Snap Peas</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="creamed_aubergine" src="images/recipe/Creamed Aubergine Wheat With Fried Sugar Snap Peas.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Creamed Aubergine Wheat With Fried Sugar Snap Peas</h3>
