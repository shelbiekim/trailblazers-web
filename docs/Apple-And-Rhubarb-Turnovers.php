...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Apple And Rhubarb Turnovers");
            findEmission("Apple And Rhubarb Turnovers");
            findNutrition("Apple And Rhubarb Turnovers");
            findIngredients("Apple And Rhubarb Turnovers");
            findInstructions("Apple And Rhubarb Turnovers");
...
<div class="breadcrumb container">
    ...
    <span>Apple And Rhubarb Turnovers</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="apple_and" src="images/recipe/Apple And Rhubarb Turnovers.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Apple And Rhubarb Turnovers</h3>
