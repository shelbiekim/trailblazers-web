...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Homemade Gnocchi");
            findEmission("Homemade Gnocchi");
            findNutrition("Homemade Gnocchi");
            findIngredients("Homemade Gnocchi");
            findInstructions("Homemade Gnocchi");
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="homemade" src="images/recipe/Homemade Gnocchi.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Homemade Gnocchi</h3>
