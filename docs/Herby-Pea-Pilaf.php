...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Herby Pea Pilaf");
            findEmission("Herby Pea Pilaf");
            findNutrition("Herby Pea Pilaf");
            findIngredients("Herby Pea Pilaf");
            findInstructions("Herby Pea Pilaf");
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="herby_pea" src="images/recipe/Herby Pea Pilaf.jpg" class="image recipe_img_main">
            <!-- copy from here -->
