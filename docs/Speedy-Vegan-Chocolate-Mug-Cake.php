...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Speedy Vegan Chocolate Mug Cake");
            findEmission("Speedy Vegan Chocolate Mug Cake");
            findNutrition("Speedy Vegan Chocolate Mug Cake");
            findIngredients("Speedy Vegan Chocolate Mug Cake");
            findInstructions("Speedy Vegan Chocolate Mug Cake");
...
<div class="breadcrumb container">
    ...
    <span>Speedy Vegan Chocolate Mug Cake</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="speedy_vegan" src="images/recipe/Speedy Vegan Chocolate Mug Cake.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Speedy Vegan Chocolate Mug Cake</h3>
            <img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/>&nbsp;&nbsp;<span class='glyphicon glyphicon-info-sign my-tooltip' title="required to offset footprint per one serve"></span>
            <hr class="minor" />
