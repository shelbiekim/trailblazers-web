...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Tomato Galette With Garlic Whipped Tahini And Fried Olives");
            findEmission("Tomato Galette With Garlic Whipped Tahini And Fried Olives");
            findNutrition("Tomato Galette With Garlic Whipped Tahini And Fried Olives");
            findIngredients("Tomato Galette With Garlic Whipped Tahini And Fried Olives");
            findInstructions("Tomato Galette With Garlic Whipped Tahini And Fried Olives");
...
<div class="breadcrumb container">
    ...
    <span>Tomato Galette With Garlic Whipped Tahini And Fried Olives</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="tomato" src="images/recipe/Tomato Galette With Garlic Whipped Tahini And Fried Olives.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Tomato Galette With Garlic Whipped Tahini And Fried Olives</h3>
