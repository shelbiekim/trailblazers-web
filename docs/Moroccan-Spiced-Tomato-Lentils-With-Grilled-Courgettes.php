...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Moroccan Spiced Tomato Lentils With Grilled Courgettes");
            findEmission("Moroccan Spiced Tomato Lentils With Grilled Courgettes");
            findNutrition("Moroccan Spiced Tomato Lentils With Grilled Courgettes");
            findIngredients("Moroccan Spiced Tomato Lentils With Grilled Courgettes");
            findInstructions("Moroccan Spiced Tomato Lentils With Grilled Courgettes");
...
<div class="breadcrumb container">
    ...
    <span>Moroccan Spiced Tomato Lentils With Grilled Courgettes</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="moroccan" src="images/recipe/Moroccan Spiced Tomato Lentils With Grilled Courgettes.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Moroccan Spiced Tomato Lentils With Grilled Courgettes</h3>
