...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Molasses Baked Beans");
            findEmission("Molasses Baked Beans");
            findNutrition("Molasses Baked Beans");
            findIngredients("Molasses Baked Beans");
            findInstructions("Molasses Baked Beans");
...
<div class="breadcrumb container">
    ...
    <span>Molasses Baked Beans</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="molasses" src="images/recipe/Molasses Baked Beans.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Molasses Baked Beans</h3>
