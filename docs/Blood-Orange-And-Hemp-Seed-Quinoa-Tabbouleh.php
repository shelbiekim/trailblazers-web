...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Blood Orange And Hemp Seed Quinoa Tabbouleh");
            findEmission("Blood Orange And Hemp Seed Quinoa Tabbouleh");
            findNutrition("Blood Orange And Hemp Seed Quinoa Tabbouleh");
            findIngredients("Blood Orange And Hemp Seed Quinoa Tabbouleh");
            findInstructions("Blood Orange And Hemp Seed Quinoa Tabbouleh");
...
<div class="breadcrumb container">
    ...
    <span>Blood Orange And Hemp Seed Quinoa Tabbouleh</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="blood_orange" src="images/recipe/Blood Orange And Hemp Seed Quinoa Tabbouleh.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Blood Orange And Hemp Seed Quinoa Tabbouleh</h3>
