...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("One Pot Pasta With A Chickpea And Tomato Sauce");
            findEmission("One Pot Pasta With A Chickpea And Tomato Sauce");
            findNutrition("One Pot Pasta With A Chickpea And Tomato Sauce");
            findIngredients("One Pot Pasta With A Chickpea And Tomato Sauce");
            findInstructions("One Pot Pasta With A Chickpea And Tomato Sauce");
...
<div class="breadcrumb container">
    ...
    <span>One Pot Pasta With A Chickpea And Tomato Sauce</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container align-center recipe-container" style="margin-top: 30px;">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="one_pot" src="images/recipe/One Pot Pasta With A Chickpea And Tomato Sauce.jpg" class="image recipe_img_main">
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">One Pot Pasta With A Chickpea And Tomato Sauce</h3>
            <img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/><img class="tree_icons" src="images/tree_icon.png" height="30"/><img src="images/half_tree_icon.png" height="30"/>&nbsp;&nbsp;<span class='glyphicon glyphicon-info-sign my-tooltip' title="required to offset footprint per one serve"></span>
            <hr class="minor" />
