...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Sticky Chinese Five Spice Vegetable Stir Fry");
            findEmission("Sticky Chinese Five Spice Vegetable Stir Fry");
            findNutrition("Sticky Chinese Five Spice Vegetable Stir Fry");
            findIngredients("Sticky Chinese Five Spice Vegetable Stir Fry");
            findInstructions("Sticky Chinese Five Spice Vegetable Stir Fry");
...
<div class="breadcrumb container">
    ...
    <span>Sticky Chinese Five Spice Vegetable Stir Fry</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="sticky" src="images/recipe/Sticky Chinese Five Spice Vegetable Stir Fry.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Sticky Chinese Five Spice Vegetable Stir Fry</h3>
