...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Spinach And Red Pepper Thai Curry");
            findEmission("Spinach And Red Pepper Thai Curry");
            findNutrition("Spinach And Red Pepper Thai Curry");
            findIngredients("Spinach And Red Pepper Thai Curry");
            findInstructions("Spinach And Red Pepper Thai Curry");
...
<div class="breadcrumb container">
    ...
    <span>Spinach And Red Pepper Thai Curry</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="spinach" src="images/recipe/Spinach And Red Pepper Thai Curry.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Spinach And Red Pepper Thai Curry</h3>
