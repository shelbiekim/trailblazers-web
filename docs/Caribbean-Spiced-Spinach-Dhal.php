...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Caribbean Spiced Spinach Dhal");
            findEmission("Caribbean Spiced Spinach Dhal");
            findNutrition("Caribbean Spiced Spinach Dhal");
            findIngredients("Caribbean Spiced Spinach Dhal");
            findInstructions("Caribbean Spiced Spinach Dhal");
...
<div class="breadcrumb container">
    ...
    <span>Caribbean Spiced Spinach Dhal</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="caribbean_spiced" src="images/recipe/Caribbean Spiced Spinach Dhal.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Caribbean Spiced Spinach Dhal</h3>
