...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Balsamic Roasted Fennel With A Bulgur And Herb Salad");
            findEmission("Balsamic Roasted Fennel With A Bulgur And Herb Salad");
            findNutrition("Balsamic Roasted Fennel With A Bulgur And Herb Salad");
            findIngredients("Balsamic Roasted Fennel With A Bulgur And Herb Salad");
            findInstructions("Balsamic Roasted Fennel With A Bulgur And Herb Salad");
...
<div class="breadcrumb container">
    ...
    <span>Balsamic Roasted Fennel With A Bulgur And Herb Salad</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="balsamic" src="images/recipe/Balsamic Roasted Fennel With A Bulgur And Herb Salad.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Balsamic Roasted Fennel With A Bulgur And Herb Salad</h3>
