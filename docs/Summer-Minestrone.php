...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Summer Minestrone");
            findEmission("Summer Minestrone");
            findNutrition("Summer Minestrone");
            findIngredients("Summer Minestrone");
            findInstructions("Summer Minestrone");
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="summer" src="images/recipe/Summer Minestrone.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Summer Minestrone</h3>
