...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Spiced Couscous Salad With Crispy Spring Onions");
            findEmission("Spiced Couscous Salad With Crispy Spring Onions");
            findNutrition("Spiced Couscous Salad With Crispy Spring Onions");
            findIngredients("Spiced Couscous Salad With Crispy Spring Onions");
            findInstructions("Spiced Couscous Salad With Crispy Spring Onions");
...
<div class="breadcrumb container">
    ...
    <span>Spiced Couscous Salad With Crispy Spring Onions</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="spiced-couscous" src="images/recipe/Spiced Couscous Salad With Crispy Spring Onions.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Spiced Couscous Salad With Crispy Spring Onions</h3>
