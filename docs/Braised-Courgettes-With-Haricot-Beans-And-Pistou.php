...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            findRecipe("Braised Courgettes With Haricot Beans And Pistou");
            findEmission("Braised Courgettes With Haricot Beans And Pistou");
            findNutrition("Braised Courgettes With Haricot Beans And Pistou");
            findIngredients("Braised Courgettes With Haricot Beans And Pistou");
            findInstructions("Braised Courgettes With Haricot Beans And Pistou");
...
<div class="breadcrumb container">
    ...
    <span>Braised Courgettes With Haricot Beans And Pistou</span>
</div>
<!-- Banner -->
<div class="container">
...
<div class="container recipe-container">
    <div class="row">
        <div class="5u" style="margin-top: 10px;">
            <img id="braised" src="images/recipe/Braised Courgettes With Haricot Beans And Pistou.jpg" class="image recipe_img_main">
            <!-- copy from here -->
        ...
        <div class="7u align-left" style="margin-top: 10px;">
            <h3 id="recipe_name">Braised Courgettes With Haricot Beans And Pistou</h3>
